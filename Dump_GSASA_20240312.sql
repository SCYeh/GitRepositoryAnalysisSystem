...
INSERT INTO `gitrepository` VALUES ('6b376ef6-76ee-4ca6-89ff-1ec7b1c2bfb5','gphotos-python-download-REST','KEEEER',NULL),('845735d5-7e87-4ad0-98b8-7b94f3fd26b3','GitRepositoryAnalysisSystem','KEEEER',NULL),('2e723743-f67c-4a6a-9c12-ba3c831b6883','gphotos-python-download-REST','KEEEER',NULL),('275147e4-992b-4e2f-8168-72c1754265b8','gphotos-python-download-REST','KEEEER',NULL),('4517f238-4826-4d28-95d4-c33acaf11377','gphotos-python-download-REST','KEEEER',NULL),('f18b8ed7-bec2-4cc0-8b62-9e2526a8754b','gphotos-python-download-REST','KEEEER',NULL),('fd50f3bb-14a0-483e-8ee0-564ac1b9a8cb','GitRepositoryAnalysisSystem','KEEEER',NULL),('5b5f8d50-60bf-4f35-9e02-19ac62f6d8e4','gphotos-python-download-REST','KEEEER',NULL),('8e07c46c-378c-481d-84e2-23758015b1e6','angular','angular',NULL),('59a764d5-3128-4516-9b62-954c6668b2b7','examples','tensorflow',NULL),('47d3f85e-1424-4f6b-8c26-d1486bc79b03','go','golang',NULL),('19c40650-b59f-46a6-a0a2-818eb5a97e03','GitRepositoryAnalysisSystem','liyo2686','e5cb80bf-fb17-4136-9996-fca39e3fa19a'),('e10bee9b-08fe-4fa5-ae02-1a0bd92dc6a0','GitRepositoryAnalysisSystem','allen880612','e5e92eb6-a5c9-4163-8420-d7225a81a10f');
...
CREATE TABLE `sonarproject` (
  `sonar_project_id` varchar(300) DEFAULT NULL,
  `host_url` varchar(300) DEFAULT NULL,
  `token` varchar(300) DEFAULT NULL,
  `project_key` varchar(300) DEFAULT NULL,
  `project_id` varchar(300) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sonarproject` VALUES ('2a4fab1d-571e-46ea-865f-549dcede0d9f','localhost:9000','squ_ca82f3b0d499b1ee84441000540619b36e6c6e46','gsas','e5cb80bf-fb17-4136-9996-fca39e3fa19a'),('640edf22-f887-42c0-bfb9-5c01a3821365','localhost:9000','squ_ca82f3b0d499b1ee84441000540619b36e6c6e46','gsas','e5e92eb6-a5c9-4163-8420-d7225a81a10f');
...
-- Dump completed on 2024-03-12 22:44:26
